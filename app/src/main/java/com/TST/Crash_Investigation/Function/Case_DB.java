...
public class Case_DB extends SQLiteOpenHelper {

    private Context context;
    public Case_DB(Context context) {
    ...
    public void onCreate(SQLiteDatabase DB) {
        DB.execSQL("create Table Case_List (Case_No NUMBER primary key,Case_Name TEXT,FIR_Number TEXT, Date Text, Area Text, Location Text, Car NUMBER, Person NUMBER,Status NUMBER)");
    }
    ...
    public Boolean Update_Status(int id,int status)
    {
